...
class Mailer:
    ...
    def __init__(self):
        ...
        self.EMAIL = "starkalina2020@gmail.com"
        # Enter the email password below. Note that the password varies if you have secured
        # 2 step verification turned on. we can refer the links below and create an application specific password.
